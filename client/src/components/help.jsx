...
<Div6><MdLocationOn color="#1970F1" size="30px"  />Delhi, India</Div6>
            ...
            Email
            <Input type="email" name="user_email" placeholder="Your mail "/><br/><br/>
            Message<br/>
            <Textarea name="message" placeholder="Share your feedback..." rows="6" required></Textarea>
            <br/>
            <Div8><Button type="submit" value="Send">Send Feedback</Button></Div8>
            </form>
