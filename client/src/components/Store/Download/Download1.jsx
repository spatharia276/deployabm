...
function Download1() {
    ...
    const getCount = async (searchTerm) => {
      const response = await axios.get(`https://api.countapi.xyz/update/animebyme/anime12/?amount=1`);
...
<IconContext.Provider value={{size: 79}}>
    <Down><ButtonD>
        <MdCloudDownload /><br/>Click the icon below to download extension
    </ButtonD></Down>
...
<Hr1/>
<Div3>DOWNLOAD<br/><Div2>{count}</Div2></Div3>
</Detail>
<Hr/>
